...
* **[AI Content Studio](https://github.com/goodman-rb/ai-content-studio)** — Веб-приложение на базе Streamlit для автоматической генерации постов в VK и Telegram с подключенным ИИ. Автоматизация через n8n.
